...
class SupportHelpersTest extends TestCase
{
    ...
    public function testDataGetWithNestedArrays()
    {
        ...
        $this->assertEquals(['taylorotwell@gmail.com', 'irrelevant', 'irrelevant'], data_get($array, '*.email', 'irrelevant'));

        $this->assertEquals(['taylor', 'abigail', 'dayle'], data_get($arrayIterable, '*.name'));
        $this->assertEquals(['taylorotwell@gmail.com', 'irrelevant', 'irrelevant'], data_get($arrayIterable, '*.email', 'irrelevant'));
        ...
        $this->assertEquals(['taylorotwell@gmail.com', 'irrelevant', 'irrelevant'], data_get($array, 'users.*.email', 'irrelevant'));
